                        ...
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="modal-dialog m-0" role="document">
                                    <div class="modal-content">
                                        ...
                                        </div>We've created a plugin to easily create a bootstrap modal.
                                ...
                                <div class="card card-mt">
                                    ...
                                    <div class="card-body">
                                        <p class="mb-2">You can easily change the default browser confirmation box
                                            with a bootstrap modal.</p>
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="mb-2">We've created a plugin to easily create a bootstrap modal.
                                        </p>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="mb-2">Check the <code>modal.js</code> code in the
                                            <code>dist/js/page</code> folder to get the source code.</p>
                                        <div class="buttons">
